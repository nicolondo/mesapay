...
OUTPUT = "/Users/nicolas/Documents/APPS/MESAPAY/docs/Propuesta-Gerente-Comercial-Independiente-MESAPAY.pdf"
...
def build():
    ...
    story.append(Paragraph("PROPUESTA · CORRETAJE MERCANTIL · LIDERAZGO COMERCIAL", style_eyebrow))
    story.append(Paragraph("Propuesta de colaboración", style_title))
    story.append(Paragraph(
        "Gerente Comercial Independiente · Modalidad: corretaje mercantil",
        style_subtitle,
    ))
    ...
    story.append(Paragraph(
        ...
        "Comerciales de MESAPAY como corretaje mercantil. Por cada cuenta que el equipo "
    ...
    story.append(Paragraph(
        ...
        "(25% mes 1 + 2,5% × 11 mes 2-12). Cifras en COP sobre suscripción.",
        style_caption,
    ))
    ...
    story.append(Paragraph(
        "Cada cuenta Premium anual del equipo te deja $839K en el bolsillo en el mes 1.",
        style_caption,
    ))
    ...
    story.append(Paragraph(
        "Pasar de 0% a 30% anual te sube el mes 1 de $7,5M a $10,0M (+33%). El total año 1 "
