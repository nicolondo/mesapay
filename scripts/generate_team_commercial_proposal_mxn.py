...
OUTPUT = "/Users/nicolas/Documents/APPS/MESAPAY/docs/Propuesta-Comercial-Equipo-Independiente-MESAPAY-MXN.pdf"
...
def build():
    ...
    story.append(Paragraph("PROPUESTA · COMISIÓN MERCANTIL · MÉXICO · EN EQUIPO", style_eyebrow))
    ...
    story.append(Paragraph(
        ...
        "MESAPAY como comisión mercantil, integrados a un <b>equipo bajo un líder "
    ...
    story.append(Paragraph(
        ...
        "(75% mes 1 + 10% × 11 mes 2-12). Cifras en MXN sobre suscripción de lista.",
        style_caption,
    ))
    ...
    story.append(Paragraph(
        "Cerrar un Premium anual te deja $14,799 en el bolsillo en el mes 1.",
        style_caption,
    ))
    ...
    data = [
        ...
        [Paragraph("Comercial con sueldo", style_td_b),
         Paragraph("con básico", style_td_r),
