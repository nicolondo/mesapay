 ...
 * necesitan los comercios que sólo imprimen tirilla. `status.einvoicingEnabled`
 * le dice al cliente qué secciones puede mostrar. La escritura de
 * credenciales (PATCH) y todo lo que toca la DIAN sí siguen gateados.
 */
